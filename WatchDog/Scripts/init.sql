...
-- Insert sample data
INSERT INTO Users (Username, Email, PasswordHash, Role, CreatedDate)
VALUES ('johndoe', 'john@example.com', '$2y$10$D2YXPlfVVj.VM8/mo7zkheLfVaI72VZFtXaeBdAWnsaQ4BqAaTAHq', 'User',
        CURRENT_TIMESTAMP),
       ('janedoe', 'jane@example.com', '$2a$11$iu7d5i8NjkpQcRkshAM83OPMmAuGzM77P.OOuzkxXaxTsBnYRKKg.', 'User',
        CURRENT_TIMESTAMP),
       ('projectlead', 'lead@example.com', '$2a$11$iu7d5i8NjkpQcRkshAM83OPMmAuGzM77P.OOuzkxXaxTsBnYRKKg.', 'User',
        CURRENT_TIMESTAMP)
ON CONFLICT (Email) DO NOTHING;

INSERT INTO Projects (Title, Description, StartDate, EndDate, Status, CreatedDate)
VALUES ('Website Redesign', 'Complete redesign of company website', CURRENT_DATE - INTERVAL '30 days',
        CURRENT_DATE + INTERVAL '60 days', 'InProgress', CURRENT_TIMESTAMP),
       ('Mobile App Development', 'Create a new mobile app for customers', CURRENT_DATE - INTERVAL '15 days',
        CURRENT_DATE + INTERVAL '90 days', 'NotStarted', CURRENT_TIMESTAMP),
       ('Database Migration', 'Migrate from legacy database to new system', CURRENT_DATE + INTERVAL '5 days',
        CURRENT_DATE + INTERVAL '45 days', 'NotStarted', CURRENT_TIMESTAMP),
       ('API Integration', 'Integrate with third-party payment APIs', CURRENT_DATE - INTERVAL '10 days', NULL,
        'InProgress', CURRENT_TIMESTAMP),
       ('Marketing Campaign', 'Q4 digital marketing campaign', CURRENT_DATE - INTERVAL '60 days',
        CURRENT_DATE - INTERVAL '10 days', 'Completed', CURRENT_TIMESTAMP)
ON CONFLICT DO NOTHING;
...
INSERT INTO Tasks (TaskDescription, Remarks, StartDate, CompletedDate, PercentageComplete, ProjectId, AssignedUserId,
                   CreatedDate)
VALUES ('Design mockups', 'Create wireframes and high-fidelity designs', CURRENT_DATE - INTERVAL '30 days',
        CURRENT_DATE - INTERVAL '15 days', 100, 1, 2, CURRENT_TIMESTAMP),
       ('Frontend implementation', 'Implement new design in HTML/CSS/JS', CURRENT_DATE - INTERVAL '14 days', NULL, 75,
        1, 2, CURRENT_TIMESTAMP),
       ('Backend API changes', 'Update API to support new features', CURRENT_DATE - INTERVAL '10 days', NULL, 40, 1, 3,
        CURRENT_TIMESTAMP),
       ('Design mobile UI', 'Create app UI designs', CURRENT_DATE - INTERVAL '15 days',
        CURRENT_DATE - INTERVAL '5 days', 100, 2, 2, CURRENT_TIMESTAMP),
       ('Develop iOS app', 'Build native iOS application', CURRENT_DATE - INTERVAL '5 days', NULL, 30, 2, 3,
        CURRENT_TIMESTAMP),
       ('Develop Android app', 'Build native Android application', CURRENT_DATE - INTERVAL '5 days', NULL, 20, 2, 2,
        CURRENT_TIMESTAMP),
       ('Data schema design', 'Design new database schema', CURRENT_DATE + INTERVAL '5 days', NULL, 0, 3, 3,
        CURRENT_TIMESTAMP),
       ('Data migration scripts', 'Write scripts to migrate existing data', CURRENT_DATE + INTERVAL '15 days', NULL, 0,
        3, 2, CURRENT_TIMESTAMP),
       ('API documentation', 'Document API endpoints and usage', CURRENT_DATE - INTERVAL '10 days',
        CURRENT_DATE - INTERVAL '2 days', 100, 4, 3, CURRENT_TIMESTAMP),
       ('Payment gateway integration', 'Integrate with payment processor', CURRENT_DATE - INTERVAL '5 days', NULL, 60,
        4, 3, CURRENT_TIMESTAMP),
       ('Content creation', 'Create campaign content', CURRENT_DATE - INTERVAL '60 days',
        CURRENT_DATE - INTERVAL '40 days', 100, 5, 2, CURRENT_TIMESTAMP),
       ('Campaign analytics', 'Analyze campaign performance', CURRENT_DATE - INTERVAL '30 days',
...
VALUES ('Welcome to the Website Redesign project! Let''s make this our best site yet.', 'Update', TRUE, 1, 1,
        CURRENT_TIMESTAMP - INTERVAL '30 days'),
       ('I''ve completed all the design mockups. Please review and provide feedback.', 'Update', FALSE, 1, 2,
        CURRENT_TIMESTAMP - INTERVAL '15 days'),
       ('Backend API changes are taking longer than expected. I might need help.', 'Update', FALSE, 1, 3,
        CURRENT_TIMESTAMP - INTERVAL '7 days'),
       ('Mobile app development project is now underway. Please check tasks assigned to you.', 'Update', TRUE, 2, 1,
        CURRENT_TIMESTAMP - INTERVAL '15 days'),
       ('The iOS implementation is going well, but we might need to extend the timeline.', 'Update', FALSE, 2, 3,
        CURRENT_TIMESTAMP - INTERVAL '3 days'),
       ('Update on the payment integration: We''re at 60% completion and on track.', 'Update', FALSE, 4, 3,
        CURRENT_TIMESTAMP - INTERVAL '2 days'),
       ('Great work on the marketing campaign! The metrics look excellent.', 'Update', TRUE, 5, 1,
        CURRENT_TIMESTAMP - INTERVAL '15 days')
ON CONFLICT DO NOTHING;
